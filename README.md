...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f56caae1-9f13-4247-94ee-bec805c9e0ca
```

> `f56caae1-9f13-4247-94ee-bec805c9e0ca` is the password of the certificate, you can change it to any password you want.
